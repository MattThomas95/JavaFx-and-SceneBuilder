...
public class ModifyProductScreenController implements Initializable {
    ...
    public void initializeProductData(Product product) {
        ...
        idTextField.setText(selectedProduct.getId().toString());
        productNameTextField.setText(selectedProduct.getName());
        invTextField.setText(selectedProduct.getStock().toString());
        priceCostTextField.setText(selectedProduct.getPrice().toString());
        maxTextField.setText(Integer.toString(selectedProduct.getMax()));
        minTextField.setText(Integer.toString(selectedProduct.getMin()));
        selectedPart.addAll(selectedProduct.getAllAssociatedParts());
    }
